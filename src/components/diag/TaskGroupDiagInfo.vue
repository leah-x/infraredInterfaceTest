<template>
  <div>
    ...
    >
      ...
      <span slot="executingNumber" slot-scope="text">
        <a-tag color="yellow">
          {{ text }}
        </a-tag>
      </span>
      <span slot="finishNumber" slot-scope="text">
        <a-tag color="blue">
          {{ text }}
        </a-tag>
      </span>
      <span slot="normalNumber" slot-scope="text">
        <a-tag color="green">
          {{ text }}
        </a-tag>
      </span>
      <span slot="abnormalNumber" slot-scope="text">
        <a-tag color="red">
          {{ text }}
        </a-tag>
      </span>
      ...
      <span slot="action" slot-scope="text, record">
        <a @click="viewItem(record.groupId)" :disabled="record.state !== 3"
          >任务组详情</a
        >
      </span>
    </a-table>
